...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GDeleteSpaceshipData.serializer)
      ..add(GDeleteSpaceshipData_deleteSpaceship.serializer)
      ..add(GDeleteSpaceshipReq.serializer)
      ..add(GDeleteSpaceshipVars.serializer)
      ..add(GGetSpaceshipData.serializer)
      ..add(GGetSpaceshipData_findSpaceshipByID.serializer)
      ..add(GGetSpaceshipReq.serializer)
      ..add(GGetSpaceshipVars.serializer)
      ..add(GGetSpaceshipsData.serializer)
      ..add(GGetSpaceshipsData_spaceships.serializer)
      ..add(GGetSpaceshipsData_spaceships_data.serializer)
      ..add(GGetSpaceshipsReq.serializer)
      ..add(GGetSpaceshipsVars.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<GGetSpaceshipsData_spaceships_data>()))
    .build();
